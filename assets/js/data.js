...
const AR_SEED_PRODUCTS = [
  { id:'p1', name:'Pashmina Viscose Dusty Rose', category:'Polos', color:'Dusty Rose', hex:'#D8A7B1', price:89000, oldPrice:110000, stock:24, sku:'AR-PV-001', desc:'Pashmina instan berbahan viscose premium yang jatuh lembut dan adem dipakai seharian. Warna dusty rose yang lembut cocok untuk acara formal maupun harian.', featured:true, image:null },
  { id:'p2', name:'Pashmina Viscose Mocha Brown', category:'Polos', color:'Mocha Brown', hex:'#8B6F52', price:89000, oldPrice:null, stock:31, sku:'AR-PV-002', desc:'Warna mocha brown yang hangat dan netral, mudah dipadukan dengan outfit apa pun. Tekstur viscose premium anti panas.', featured:true, image:null },
  { id:'p3', name:'Pashmina Viscose Olive Sage', category:'Polos', color:'Olive Sage', hex:'#6B7A4A', price:85000, oldPrice:99000, stock:0, sku:'AR-PV-003', desc:'Olive sage yang earthy dan elegan. Bahan viscose 2 sisi doff, tidak menerawang dan mudah dibentuk.', featured:false, image:null },
  { id:'p4', name:'Pashmina Viscose Navy Storm', category:'Polos', color:'Navy Storm', hex:'#2C3E60', price:89000, oldPrice:null, stock:18, sku:'AR-PV-004', desc:'Navy storm yang tegas dan profesional, pilihan favorit untuk hijab kerja dan seragam kantor.', featured:true, image:null },
  { id:'p5', name:'Pashmina Viscose Maroon Velvet', category:'Polos', color:'Maroon', hex:'#6B2C39', price:92000, oldPrice:105000, stock:9, sku:'AR-PV-005', desc:'Merah maroon pekat yang mewah, cocok untuk acara pernikahan dan momen spesial.', featured:false, image:null },
  { id:'p6', name:'Pashmina Viscose Sand Beige', category:'Polos', color:'Sand Beige', hex:'#C7B892', price:85000, oldPrice:null, stock:40, sku:'AR-PV-006', desc:'Sand beige netral yang lembut di mata, best seller untuk pemakaian sehari-hari.', featured:true, image:null },
  { id:'p7', name:'Pashmina Viscose Onyx Black', category:'Polos', color:'Onyx Black', hex:'#1C1C1C', price:89000, oldPrice:null, stock:52, sku:'AR-PV-007', desc:'Hitam pekat klasik, wajib punya. Material viscose premium dua sisi, ringan dan tidak panas.', featured:true, image:null },
  { id:'p8', name:'Pashmina Viscose Dusty Blue', category:'Polos', color:'Dusty Blue', hex:'#7B93A6', price:85000, oldPrice:95000, stock:15, sku:'AR-PV-008', desc:'Dusty blue yang menenangkan, favorit untuk gaya kasual harian.', featured:false, image:null },
  { id:'p9', name:'Pashmina Viscose Lilac Mist', category:'Polos', color:'Lilac Mist', hex:'#B497BD', price:85000, oldPrice:null, stock:0, sku:'AR-PV-009', desc:'Ungu lilac yang lembut dan feminin, cocok untuk tampilan yang playful namun tetap sopan.', featured:false, image:null },
  ...
  { id:'p11', name:'Pashmina Print Garis Senja', category:'Motif', color:'Multicolor', hex:'#A2503A', price:98000, oldPrice:null, stock:20, sku:'AR-PP-011', desc:'Motif garis gradasi warna senja, memberi kesan modern dan effortless.', featured:false, image:null },
  { id:'p12', name:'Pashmina Viscose Cream Ivory', category:'Polos', color:'Cream Ivory', hex:'#EDE4D3', price:85000, oldPrice:null, stock:27, sku:'AR-PV-012', desc:'Cream ivory yang soft dan mudah dipadukan, cocok jadi basic collection kamu.', featured:false, image:null },
];
...
function arInit(){
  ...
  if(existingProducts === null){
    ...
    existingProducts.forEach(p => {
      if(!('image' in p)){
        p.image = seedById[p.id] ? seedById[p.id].image : null;
        changed = true;
      }
    });
    if(changed) arSet(AR_KEYS.PRODUCTS, existingProducts);
  }
